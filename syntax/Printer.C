...
void PrintAbsyn::visitExtClassDef(ExtClassDef *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitBloc(Bloc *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitClassBloc(ClassBloc *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);

  render('{');
  _i_ = 0; visitListClassStmt(p->listclassstmt_);
  render('}');
...
void PrintAbsyn::visitListClassStmt(ListClassStmt *listclassstmt)
{
  iterListClassStmt(listclassstmt->begin(), listclassstmt->end());
}

void PrintAbsyn::iterListClassStmt(ListClassStmt::const_iterator i, ListClassStmt::const_iterator j)
{
  if (i == j) return;
  { /* cons */
    (*i)->accept(this); iterListClassStmt(i+1, j);
  }
}
...
void PrintAbsyn::visitClassStmt(ClassStmt *p) {} //abstract class

void PrintAbsyn::visitClassEmpty(ClassEmpty *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitClassDecl(ClassDecl *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitClassMethod(ClassMethod *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitExtIdent(ExtIdent *p) {} //abstract class

void PrintAbsyn::visitId(Id *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitArrId(ArrId *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitAttrId(AttrId *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitPrimType(PrimType *p) {} //abstract class
...
void PrintAbsyn::visitPrimitive(Primitive *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);

  _i_ = 0; p->primtype_->accept(this);

  if (oldi > 0) render(_R_PAREN);
  _i_ = oldi;
}

void PrintAbsyn::visitObjectType(ObjectType *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitECastPrim(ECastPrim *p)
{
  int oldi = _i_;
  if (oldi > 7) render(_L_PAREN);
...
void PrintAbsyn::visitEObject(EObject *p)
{
  int oldi = _i_;
  if (oldi > 6) render(_L_PAREN);
...
void ShowAbsyn::visitExtClassDef(ExtClassDef *p)
{
  bufAppend('(');
  bufAppend("ExtClassDef");
  bufAppend(' ');
  visitIdent(p->ident_1);
  bufAppend(' ');
  visitIdent(p->ident_2);
...
void ShowAbsyn::visitBloc(Bloc *p)
{
  bufAppend('(');
  bufAppend("Bloc");
  bufAppend(' ');
...
void ShowAbsyn::visitClassBloc(ClassBloc *p)
{
  bufAppend('(');
  bufAppend("ClassBloc");
  bufAppend(' ');
  bufAppend('[');
  if (p->listclassstmt_)  p->listclassstmt_->accept(this);
  bufAppend(']');
  bufAppend(' ');
  bufAppend(')');
}
void ShowAbsyn::visitListClassStmt(ListClassStmt *listclassstmt)
{
  for (ListClassStmt::const_iterator i = listclassstmt->begin() ; i != listclassstmt->end() ; ++i)
  {
    (*i)->accept(this);
    if (i != listclassstmt->end() - 1) bufAppend(", ");
  }
}
...
void ShowAbsyn::visitClassStmt(ClassStmt *p) {} //abstract class

void ShowAbsyn::visitClassEmpty(ClassEmpty *p)
{
  bufAppend("ClassEmpty");
}
void ShowAbsyn::visitClassDecl(ClassDecl *p)
{
  bufAppend('(');
  bufAppend("ClassDecl");
  bufAppend(' ');
...
void ShowAbsyn::visitClassMethod(ClassMethod *p)
{
  bufAppend('(');
  bufAppend("ClassMethod");
  bufAppend(' ');
  bufAppend('[');
  if (p->type_)  p->type_->accept(this);
  bufAppend(']');
...
void ShowAbsyn::visitAss(Ass *p)
{
  ...
  bufAppend(' ');
  bufAppend('[');
  if (p->extident_)  p->extident_->accept(this);
  bufAppend(']');
  bufAppend(' ');
  bufAppend('[');
...
void ShowAbsyn::visitExtIdent(ExtIdent *p) {} //abstract class

void ShowAbsyn::visitId(Id *p)
{
  bufAppend('(');
  bufAppend("Id");
  bufAppend(' ');
...
void ShowAbsyn::visitArrId(ArrId *p)
{
  bufAppend('(');
  bufAppend("ArrId");
  bufAppend(' ');
...
void ShowAbsyn::visitAttrId(AttrId *p)
{
  bufAppend('(');
  bufAppend("AttrId");
  bufAppend(' ');
...
void ShowAbsyn::visitPrimType(PrimType *p) {} //abstract class
...
void ShowAbsyn::visitPrimitive(Primitive *p)
{
  bufAppend('(');
  bufAppend("Primitive");
  bufAppend(' ');
  bufAppend('[');
  if (p->primtype_)  p->primtype_->accept(this);
  bufAppend(']');
  bufAppend(')');
}
void ShowAbsyn::visitObjectType(ObjectType *p)
{
  bufAppend('(');
  bufAppend("ObjectType");
  bufAppend(' ');
  visitIdent(p->ident_);
  bufAppend(')');
}
...
void ShowAbsyn::visitECastPrim(ECastPrim *p)
{
  bufAppend('(');
  bufAppend("ECastPrim");
  bufAppend(' ');
...
void ShowAbsyn::visitEObject(EObject *p)
{
  bufAppend('(');
  bufAppend("EObject");
  bufAppend(' ');
