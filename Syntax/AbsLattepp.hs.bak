...
-- | The abstract syntax of language Lattepp.

module Syntax.AbsLattepp where
...
data TopDef' a
    ...
    | ClassDef a Ident (ClassBlock' a)
    | ExtClassDef a Ident Ident (ClassBlock' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data ClassBlock' a = ClassBlock a [ClassStmt' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Stmt' a
    ...
    | For a (Type' a) Ident (ExtIdent' a) (Stmt' a)
    | SExp a (Expr' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
type ExtIdent = ExtIdent' BNFC'Position
data ExtIdent' a
    = Id a Ident
    | ArrId a Ident (Expr' a)
    | AttrId a (Expr' a) (Expr' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type PrimType = PrimType' BNFC'Position
data PrimType' a = Int a | Str a | Bool a | Void a
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Type = Type' BNFC'Position
data Type' a
    = Primitive a (PrimType' a)
    | ObjectType a Ident
    | Array a (Type' a)
    | Fun a (Type' a) [Type' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Expr' a
    ...
    | ECastPrim a (PrimType' a) (Expr' a)
    | ENewObject a Ident
    | ENewArr a (Type' a) (Expr' a)
    | ENull a
    | EObject a (Expr' a) (Expr' a)
    | EArr a Ident (Expr' a)
    | EVar a Ident
    | ELitInt a Integer
    | ELitTrue a
...
instance HasPosition ExtIdent where
  hasPosition = \case
    Id p _ -> p
    ArrId p _ _ -> p
    AttrId p _ _ -> p
